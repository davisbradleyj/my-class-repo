...
db.students.insert({name: 'Poppe', row:3, os:'Mac', hobbies:["Reading", "Surfing", "Dancing"] })

db.students.insert({name: 'Stephon', row:1, os:'Mac', hobbies:['Coding', 'Music', 'Dogs', 'Working Out'] })

db.students.insert({name: 'Kasey', row:1, os:'Windows', hobbies:['Coding', 'Reading'] })

db.students.insert({name: 'Ana', row:3, os:'Mac', hobbies:['Coding', 'Hiking', 'MCU', 'Dabbing'] })
...
db.students.find({name:'Kasey'})


db.students.find({$or:[{name:'Kasey'},{name:'Anna'}]})

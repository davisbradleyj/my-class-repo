...
* Create a MySQL database with the tables and data which were slacked out to you. - done

* Create a Node app and connect it to MySQL with a `config` folder and with a `connection.js` file inside of that folder. - done

...
// Tell "go" button to listen for a click
$("#go").on("click", function(){
  console.log("clicked!");
  bubbleSort(unsortedArr);
  $("#result").text(unsortedArr);
})
// // Bubble sort through array

//   // Iterate through array
// 
//   // If element x is bigger than x+1, swap them
//     if(array[i]>array[i + 1]){
//       var temp = array[i]
//       array[i] = array[i + 1];
//       array[i + 1] = temp;
...
//     }
//   }
//   // If a swap occurred, rerun Bubble Sort
//   if(swap === true){
//     bubbleSort(array);
//   }
// }

...
# These names are indicative of what they do. 
# For attr_reader, we can only set values when we instantiate the class. 
# With setter, we can retoractively change those values after we've already instantiated the class. 
# attr_accessor lets us do both. As such, you will probably want to default to "accessor" unless you want some more 
# explicit restrictions on your classes. 

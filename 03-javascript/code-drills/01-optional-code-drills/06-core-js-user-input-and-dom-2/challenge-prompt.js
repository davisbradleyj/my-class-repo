...
var wantsBoba = confirm("Welcome to the Boba Shop!  Can we help you with something?");
...
if (wantsBoba === true) {
    ...
    document.write("Thank you for your order. Your " + drinkFlavor + " boba will be ready soon.");
    
// Else, write "Goodbye! Come back soon!" to the DOM
} else {
    document.write("Ok, thanks for stopping by anyway, and have a nice day!");
}

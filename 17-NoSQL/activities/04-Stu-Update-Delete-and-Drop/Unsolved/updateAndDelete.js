...
// fill in mongo commands here
db.students.update({"name":"Will"}, {$set: {"hobbies":"Extreme Basketweaving"}})
...
// fill in mongo commands here
db.students.update({"name":"Will"}, {$push: {"os":"Win"}})
...
// fill in mongo commands here
db.students.remove({"name":"Juliette"})
...
// fill in mongo commands here
db.students.update({"name":"Brad"}, {$set: {"gavecandy":false})

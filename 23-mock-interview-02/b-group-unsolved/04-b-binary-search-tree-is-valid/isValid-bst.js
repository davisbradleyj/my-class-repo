...
Tree.prototype.isValid = function () {
  ...
  // recursively check each node to see if they follow the rules of a BST. Note that the return statement returns the conjunction (AND statement) of TWO functions 
